...
export const ArtieBot = () => {
    ...
    return (
        <section className="text-center flex flex-col w-full max-w-4xl mx-auto h-auto bg-opacity-45 dark:bg-opacity-30 bg-stone-700 dark:bg-gray-800 p-4 md:p-8 rounded-lg shadow-2xl">
